...
int main_wow(void)
{
	...
	// Este caso é absolutamente idêntico, se se tiver em conta que uma cadeia
	// de caracteres literal em C é equivalente à definição de um _array_ de
	// `char` (e não `const char`, como seria expectável) com um nome aleatório,
	// com o mesmo número de caracteres da cadeia literal, e à utilização desse
	// nome no código.
