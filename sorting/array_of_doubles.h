...
// de erro.
double *new_double_array_of(int length);
...
double *resize_double_array_to(double *items, int new_length);
...
double *read_double_array_from(const char *file_name, int *length);
...
// tiver o valor zero.
void copy_double_array(int length, double copy[length],
...
bool double_arrays_equal(int length, const double first[length],
...
struct double_statistics double_array_statistics(int length,
